...
import { Text, Group, Box, Paper, em, Image } from '@mantine/core'

export default function Residence() {
    return (
        <Paper shadow="xs" p="md" w={em(950)}>
            <Group>
                <Text size={em(16)}>
            ...
            <Box mt={em(15)}>
                ...
                <Text>
                    Mr/Mme/Mlle: <Text span>Rafalimanana Jean Sébastien</Text>{' '}
                </Text>
                <Text>
                ...
                <Text>CIN N° : xxx xxx xxx xxx du dd MMMM aaaa à Ihosy</Text>
                <Text>
                    Réside à: Soatsiadino, Fokontany Soatsihadino sous N° xxx du
                    resistre
                </Text>
                <Text mt={30}>
                    En foi de quoi, le présent cetificat lui est délicrée pour
                    servir et valoir ce que de droit.
                </Text>
                <Text align='right' mt={em(30)} mr={em(120)}>Fait à #FOKOTANY, le dd MMMM aaaa</Text>
                <Text align='right' mt={em(30)} mr={em(140)} weight={"bold"}>LE CHEF FOKONTANY</Text>
            </Box>
        </Paper>
    )
}
